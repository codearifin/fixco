...
//$mail->Password = 'ocdoqvtokpmwnrmh';                  // SMTP password
...
$mail->setFrom('no-reply@fixcomart.com', 'Mailer From Siapa fixcomart');

$mail->addAddress('ranto@nukegraphic.com', 'Ranto Lim');     // Add a recipient
