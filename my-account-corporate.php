<?php include("header.php"); 
	...
	$query2 = $db->query("SELECT * FROM `member_membership_data` WHERE `idmember`='$idmember'");
	...
	<div class="container">
    	<div class="row">
        	<ul class="breadcrumbs">
                ...
                <li class="f-pb">Akun Saya (Corporate)</li>
            </ul><!-- .breadcrumbs -->
        </div><!-- .row -->
    </div><!-- .container -->
</section><!-- #breadcrumbs -->
	...
	<div class="container">
    	<div class="row">
            ...
            <div class="template-wrap">
                <h1 class="f-pb">Corporate Profil</h1>
             
             <?php if($superuserstatus==0):?>
			 
                        <form action="" method="post" class="general-form profile-form" id="edit_register_formcrpporate">
                           
                            <div class="boxed-form">
                                <h2 class="boxed-heading f-pb">CORPORATE PROFIL</h2>
                                <div class="boxed-content">
                                    
                                    <div class="form-group">
                                        <label class="f-pb">Nama Perusahaan</label>
                                        <div class="input-wrap">
                                            <input type="text" maxlength="200" name="company_name" value="<?php echo $data['company_name'];?>" disabled="disabled" />
                                             <span></span>
                                        </div><!-- .input-wrap -->
                                    </div><!-- .form-group -->
                                    <div class="form-group">
                                        ...
                                        <div class="input-wrap">
                                            <input type="text" value="<?php echo $data['npwp'];?>" name="npwp" disabled="disabled" />
                                             <span></span>
                                        </div><!-- .input-wrap -->
                                    </div><!-- .form-group -->
                                    ...
                                    <div class="tc-form-group">
                                        <div class="form-group">
                                            ...
                                            <div class="input-wrap">
                                                <input type="text" name="name" value="<?php echo $res['name'];?>" maxlength="200" disabled="disabled" />
                                                <span></span>
                                            </div><!-- .input-wrap -->
                                        </div><!-- .form-group -->
                                        <div class="form-group">
                                            ...
                                            <div class="input-wrap">
                                                <input type="text" name="lastname" value="<?php echo $res['lastname'];?>" maxlength="100" disabled="disabled" />
                                                <span></span>
                                            </div><!-- .input-wrap -->
                                        </div><!-- .form-group -->
                                    </div><!-- .tc-form-group -->
                                    <div class="tc-form-group">
                                        <div class="form-group">
                                            ...
                                            <div class="input-wrap">
                                                <input type="text" name="phone" maxlength="20" value="<?php echo $res['phone'];?>" disabled="disabled" />
                                                <span></span>
                                            </div><!-- .input-wrap -->
                                        </div><!-- .form-group -->
                                        <div class="form-group">
                                            ...
                                            <div class="input-wrap">
                                                <input type="text" name="mobilephone" maxlength="20" value="<?php echo $res['mobile_phone'];?>"  disabled="disabled" />
                                                <span></span>
                                            </div><!-- .input-wrap -->
                                        </div><!-- .form-group -->
                                    </div><!-- .tc-form-group -->
			 ...
			 <?php else:?>
					 ...
					 <?php if($res['status_complete']==0): 
                        ...
                        ?>
                        <form action="<?php echo $GLOBALS['SITE_URL'];?>do-update-profile-corporate" method="post" class="general-form profile-form" id="edit_register_formcrpporate">
                            ...
                            <div class="boxed-form">
                                ...
                                <div class="boxed-content">
                                    ...
                                    <div class="form-group">
                                        <label class="f-pb">Nama Perusahaan</label>
                                        <div class="input-wrap">
                                            <input type="text" maxlength="200" name="company_name" value="<?php echo $data['company_name'];?>" />
                                             <span></span>
                                        </div><!-- .input-wrap -->
                                    </div><!-- .form-group -->
                                    <div class="form-group">
                                        <label class="f-pb">NPWP Perusahaan <em>(optional)</em></label>
                                        <div class="input-wrap">
                                            <input type="text" value="<?php echo $data['npwp'];?>" name="npwp" />
                                             <span></span>
                                        </div><!-- .input-wrap -->
                                    </div><!-- .form-group -->
                                    ...
                                    <div class="tc-form-group">
                                        <div class="form-group">
                                            ...
                                            <div class="input-wrap">
                                                <input type="text" name="email" id="email" value="<?php echo $res['email'];?>" maxlength="200"  disabled/>
                                                <span></span> 
                                            </div><!-- .input-wrap -->
                                        </div><!-- .form-group -->
                                        <div class="form-group">
