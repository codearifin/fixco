<?php include("header.php"); 
	...
	$statususer = $ros['status'];
	$iduserdefault = $ros['id'];
	
	//filter ordder
	if(isset($_SESSION['sort_filtertahundraf'])): $sort_filtertahun = $_SESSION['sort_filtertahundraf']; else: $sort_filtertahun = ""; endif;	
	if(isset($_SESSION['member_filteruid'])): $member_filteruid = $_SESSION['member_filteruid']; else: $member_filteruid = 0; endif;	
	...
	<div class="container">
    	<div class="row">
            ...
            <div class="template-wrap">
                <h1 class="f-pb">Draft Quotation</h1>
                        ...
                        <div class="input-wrap">
                            <div class="select-style">
                                ...
                                ?>        
                                 ...
                                 <input type="hidden" name="name_sort" class="name_sortuid" value="sort_filtertahundraf" /> 
                            </div><!-- .select-style -->
                        </div><!-- .input-wrap -->
                    </div><!-- .tsc -->
                    <div class="tsc">
                        ...
                        <div class="input-wrap">
                            <div class="select-style">
                                <select class="generalsortprodlistmember">
                                    <?php listmembercorporate($Usertokenid,$member_filteruid);?>
                                </select>
                                <input type="hidden" name="name_sortuidmember" class="name_sortuidmember" value="member_filteruid" /> 
                            </div><!-- .select-style -->
                        </div><!-- .input-wrap -->
                    </div><!-- .tsc -->
                </div><!-- .table-sort -->
                
                <div class="order-table quotation-table">
                    ...
                    <div class="ot-body">
                        <?php getquotetaionlist($idmember,$iduserdefault,$member_filteruid,$statususer,$sort_filtertahun);?>		
                    </div><!-- .ot-body -->
                </div><!-- .order-table -->
