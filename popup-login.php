...
<div class="popup-wrap popup-small popup-login">
    ...
    <div class="popup-content">
    	<div style="text-align:right; padding-bottom:10px; font-size:14px;">
        	<a href="<?php echo $GLOBALS['SITE_URL'];?>login-corporate" class="nuke-fancied2"><u>Login Corporate!</u></a>
        </div>
        
        <form action="<?php echo $GLOBALS['SITE_URL'];?>do-login-order" method="post" class="general-form" id="login_formuidPopup">
