...
$ros = $query->fetch_assoc();
$idmember = $ros['id'];
	
if(isset($_GET['id'])): $idabook = replaceUrel($_GET['id']); else: $idabook = 0; endif;
$qupp = $db->query("SELECT * FROM `address_book` WHERE `id`='$idabook' and `member_id`='$idmember' ");
...
<div class="popup-wrap popup-medium">
    ...
    <div class="popup-content">
        <form action="<?php echo $GLOBALS['SITE_URL'];?>do-edit-address-book-checkout" method="post" class="general-form" id="addressbook_form">
