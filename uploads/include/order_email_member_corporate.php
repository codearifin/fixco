                                ...
                                <tr>
                                    <td style="padding:20px;">   
                                         ...
                                         <p>This is the receipt of your order.<br /><br />
                                            Order Detail:
                                                 ...
                                                 <table width="100%" class="general-table" style="font-family:calibri; font-size:13px;">
                                                  ...
                                                  <?php endif;?>                                  
                                                    ...
                                                    <?php if($totaldeposit>0 and $gunakan_deposit=="OKE" and $deposit_amount>0):?>		
                                                        ...
                                                        <tr>
                                        			     ...
                                        			     <tr>
                                                            <td colspan="2" align="left"> </td>
                                                            <td colspan="2" align="right"><strong>Bayar Deposit</strong></td>
                                                            <td align="right"><strong>- <?php echo'Rp. '.number_format($deposit_amount);?></strong>
                                                           </td>
                                                  	    </tr>	
                                                        
                                                         <tr>
                                                            <td colspan="2" align="left"> </td>
                                                            <td colspan="2" align="right"><strong>Sisa Pembayaran Anda</strong></td>
                                                            <td align="right"><strong>- <?php echo'Rp. '.number_format($totalbayar_potongdepo);?></strong>
                                                           </td>
                                                  	    </tr>
                                                    ...
                                                    <?php else:?>
                                                      ...
                                                      <tr>
                                                            <td colspan="2" align="left"> </td>
                                                            <td colspan="2" align="right"><strong>Grand Total</strong></td>
                                                            <td align="right"><strong><?php echo'Rp. '.number_format($totalfixorder+$lastkodeunikid);?></strong>
                                                           </td>
                                                        </tr>		
                                            ...
                                            <p>Payment Method: <strong><?php echo $payment_metodList;?></strong></p>
                                            <p><strong>Shipping Address:</strong></p>
                                            <?php echo $alamatKirim;?>
                                            
                                            <?php if($payment_metodList=="BANK TRANSFER"):?>
