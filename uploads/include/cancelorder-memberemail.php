<?php
	...
	$mail->addAddress($emailmember, $ordecanceltext); 
	$mail->addBCC($emailconfig, $ordecanceltext);	
                ...
                <table cellpadding="0" cellspacing="0" border="0" id="grey-wrap" width="650">
                    ...
                    <tr>
                        ...
                        <td style="padding:25px; padding-top:5px;">
							 ...
							 <h1 style="color:#1694B9;">Order Cancel Notification</h1>
							 ...
							 <table cellpadding="0" cellspacing="0" border="0" id="white-wrap" bgcolor="#ffffff" style="margin-bottom:10px;" width="100%">
                                ...
                                <tr>
                                    ...
                                    <td style="padding:2px;">
                                        ...
                                        <p>ORDER ID: <strong style="font-size:20px;">#<?php echo sprintf('%06d',$ordidmm);?></strong></p>  
                                        
                                        <p>TOTAL AMOUNT: <strong style="font-size:16px;">IDR <?php echo number_format($totalamount);?></strong></p>
