<?php
	...
	$mail->addAddress($emailconfig, $depositconfirmemailtext); 
                ...
                <table cellpadding="0" cellspacing="0" border="0" id="grey-wrap" width="650">
                    ...
                    <tr>
                        ...
                        <td style="padding:25px; padding-top:5px;">
							 ...
							 <h1 style="color:#1694B9;">Top Up Deposit Notification</h1>
							 ...
							 <table cellpadding="0" cellspacing="0" border="0" id="white-wrap" bgcolor="#ffffff" style="margin-bottom:10px;" width="100%">
                                ...
                                <tr>
                                    ...
                                    <td style="padding:2px;">
                                        ...
                                        <p>Member Anda Telah Melakukan Top Up Deposit.</p>

                                        <p>Nominal Transfer	: 		Rp. <?php echo number_format($jumlahdeposit);?></p>
                                        
                                        <p>Dari bank		:	 	<?php echo $nama_bank;?></p>
                                        
                                        <p>Pemilik Rekening	: 		<?php echo $atas_nama;?></p>
                                        
                                        <p>Tanggal Trf		: 		<?php echo $tanggal;?></p> 
...
<?php
		...
		$mail->isHTML(true);
		$mail->Subject = $depositconfirmemailtext;
