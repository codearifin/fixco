<?php 
	...
	$mail->addAddress($emailconfig, $upgrademembership); 
                ...
                <table cellpadding="0" cellspacing="0" border="0" id="grey-wrap" style="margin-bottom:10px; background-repeat:repeat-x;" width="990">
                    <tr>
                        <td style="padding:20px 25px 25px 25px;">
							 <h1 style="color:#1694B9;"><?php echo $upgrademembership;?></h1>
							
							 <table cellpadding="0" cellspacing="0" border="0" id="white-wrap" bgcolor="#ffffff" style="margin-bottom:10px;" width="100%">
                                <tr>
                                    <td style="padding:20px;">   

                                         <p>Hi! Silahkan cek member ini mengajukan untuk menjadi corporate member dan telah melakukan Top Up Deposit,</p>
                                      	 <p>Nama Member					: <?php echo $namamember;?></p>
                              			 <p>Nama Perusahaan				: <?php echo $companyname;?></p>
                                         <?php if($npwpcomany<>''):?>
                                         <p>NPWP Perusahaan				: <?php echo $npwpcomany;?></p>
                                         <?php endif;?>
                                         <p>Jumlah Deposit				: <?php echo $totaldeposit;?></p>
                                         <p>Transfer ke	Rekening		: <?php echo $namabankacount;?></p>        
...
<?php
		...
		$mail->isHTML(true);
		$mail->Subject = $upgrademembership;
