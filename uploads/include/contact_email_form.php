<?php
	...
	$mail->addAddress($emailconfig, $inquiry_subject); 
                ...
                <table cellpadding="0" cellspacing="0" border="0" id="grey-wrap" style="margin-bottom:10px; background-repeat:repeat-x;" width="700">
                    <tr>
                        <td style="padding:0px 25px 25px 25px;">
							 <h1 style="color:#1694B9; text-transform:uppercase;"><?php echo $nameconfig;?></h1>
							 ...
							 <table cellpadding="0" cellspacing="0" border="0" id="white-wrap" bgcolor="#ffffff" style="margin-bottom:10px;" width="100%">
                                <tr>
                                    <td style="padding:15px 15px 15px 15px;">   
                                        ...
                                        <p><?php echo $inquiry_subject;?></p>
                                        <p> Name 			: <strong><?php echo $name;?></strong></p>  
                                        <p> Phone 			: <?php echo $phone;?></p> 
                                        <p> Email	 		: <?php echo $email;?></p> 
                                        <p> Message 		: <?php echo $pesanmember;?></p>                                      
                                       
                                        <p>&nbsp;</p>  
										<p>Cheers, </p>
                                        <p><?php echo ucwords($nameconfig);?></p>
                                    </td>
                                </tr>
                            </table><!-- #white-wrap -->  
                        </td>
