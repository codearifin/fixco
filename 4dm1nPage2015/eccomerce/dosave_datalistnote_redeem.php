...
//get max id
$qum = $db->query("SELECT MAX(id) AS idmax FROM `status_detailorder_redeem`");
$r = $qum->fetch_assoc();	
$idmaxno = $r['idmax']+1;		
$query = $db->query("INSERT INTO `status_detailorder_redeem` (`id`,`idorder`,`description`,`date`) VALUES ('$idmaxno','$orderid','$notetext','$dateNow') ");
