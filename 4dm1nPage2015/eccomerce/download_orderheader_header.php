<style>
    ...
    <div style="width:550px; padding:10px 20px 10px 20px;">     
    			<div style="padding-top:20px; padding-bottom:20px; font-weight:600; font-size:16px;">DOWNLOAD ORDER HEADER</div>  
            	<form action="eccomerce/do_download_orderheader_header.php" method="post" enctype="multipart/form-data" class="form-submitcari">
                   
                    <table cellspacing="0" cellpadding="0" class="browse-table-download">
                        ...
                        <tr>
                            <td style="padding-bottom:10px; width:150px;"><label for="dash-urel">Status Order</label></td>
                            <td style="padding-bottom:10px;">
                        ...
                        <tr>
                            <td style="padding-bottom:10px; width:150px;"><label for="dash-urel2">Metode Pembayaran</label></td>
                            <td style="padding-bottom:10px;">
