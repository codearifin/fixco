<?php
	...
	$mail->addAddress($emailmember, "Commission Withdrawal Notification On Fixcomart"); 
                ...
                <table cellpadding="0" cellspacing="0" border="0" id="grey-wrap" width="650">
                    ...
                    <tr>
                        ...
                        <td style="padding:25px; padding-top:5px;">
							 ...
							 <h1 style="color:#1694B9;"><?php echo'Commission Withdrawal Notification On Fixcomart';?></h1>
							 ...
							 <table cellpadding="0" cellspacing="0" border="0" id="white-wrap" bgcolor="#ffffff" style="margin-bottom:10px;" width="100%">
                                ...
                                <tr>
                                    ...
                                    <td style="padding:2px;">
                                        ...
                                        <p>Maaf Commission Withdrawal tidak dapat kami proses.</p>
                                        
                                        <p><?php echo $notemember;?></p>
                                        
                                        <p>Commission Withdrawal Detail:</p>
                                        
                                        <p>Total Claim		: Rp. <?php echo number_format($totalclaim);?></p> 
                                        
                                        <p>Bank Account		: <?php echo $bankaccount;?></p> 
...
<?php
		...
		$mail->isHTML(true);
		$mail->Subject = "Commission Withdrawal Notification On Fixcomart";
