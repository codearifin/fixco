<?php
	...
	$mail->addAddress($emailmember, "Topup Deposit Notification On Fixcomart"); 
                ...
                <table cellpadding="0" cellspacing="0" border="0" id="grey-wrap" width="650">
                    ...
                    <tr>
                        ...
                        <td style="padding:25px; padding-top:5px;">
							 ...
							 <h1 style="color:#1694B9;"><?php echo'Topup Deposit Notification On Fixcomart';?></h1>
							 ...
							 <table cellpadding="0" cellspacing="0" border="0" id="white-wrap" bgcolor="#ffffff" style="margin-bottom:10px;" width="100%">
                                ...
                                <tr>
                                    ...
                                    <td style="padding:2px;">
                                        ...
                                        <p>Topup Deposit Anda telah kami proses, dan telah ditambahkan ke saldo Anda.</p>
                                        
                                        <p>Total Deposit		: Rp. <?php echo number_format($totaldepo);?></p>
...
<?php
		...
		$mail->isHTML(true);
		$mail->Subject = "Topup Deposit Notification On Fixcomart";
