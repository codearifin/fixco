<?php
	...
	$mail->addAddress($emailmember, "Upgrade Membership Notification On Fixcomart"); 
                ...
                <table cellpadding="0" cellspacing="0" border="0" id="grey-wrap" width="650">
                    ...
                    <tr>
                        ...
                        <td style="padding:25px; padding-top:5px;">
							 ...
							 <h1 style="color:#1694B9;"><?php echo'Upgrade Membership Notification On Fixcomart';?></h1>
							 ...
							 <table cellpadding="0" cellspacing="0" border="0" id="white-wrap" bgcolor="#ffffff" style="margin-bottom:10px;" width="100%">
                                ...
                                <tr>
                                    ...
                                    <td style="padding:2px;">
                                        ...
                                        <p>
                                        	<?php if($status_list=="Confirmed"):?>
                                            		
                                                    Selamat status member corporate anda sudah active, Silahkan login sebagai corporate member.<br />
                                                    
                                                    Topup saldo sudah ditambahkan ke Akun Anda, Sebesar: Rp. <?php echo number_format($jumlahdeposit);?><br />
                                                    
													<?php echo $notemember;?>
                                            		
                                            <?php else:?>
                                            		Maaf status member corporate anda belum dapat kami proses.
                                                    <br />
                                                    <?php echo $notemember;?>
                                            <?php endif;?>
                                        </p>
...
<?php
		...
		$mail->isHTML(true);
		$mail->Subject = "Upgrade Membership Notification On Fixcomart";
