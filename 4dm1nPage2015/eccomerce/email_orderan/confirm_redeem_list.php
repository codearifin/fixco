<?php
	...
	$mail->addAddress($emailmember, "Redeem History Notification On Fixcomart"); 
                ...
                <table cellpadding="0" cellspacing="0" border="0" id="grey-wrap" width="650">
                    ...
                    <tr>
                        ...
                        <td style="padding:25px; padding-top:5px;">
							 ...
							 <h1 style="color:#1694B9;"><?php echo'Redeem History Notification On Fixcomart';?></h1>
							 ...
							 <table cellpadding="0" cellspacing="0" border="0" id="white-wrap" bgcolor="#ffffff" style="margin-bottom:10px;" width="100%">
                                ...
                                <tr>
                                    ...
                                    <td style="padding:2px;">
                                        ...
                                        <p>Selamat redeem produk anda telah kami proses, Redeem ID <?php echo '#'.sprintf('%06d',$iddata);?>
                                           <br /><?php echo $notemember;?>
                                        </p>
 
                                        <p>Kurir <?php echo $kurir;?></p>    
                                        <?php if($noresi!=""): echo'<p>No. Res : '.$noresi.'</p>'; endif;?>
                                        <p>Alamat Pengiriman :</p>
                                        <p>
											   <?php echo'<strong>'.$row['nama_penerima'].'</strong> ('.$row['phone_penerima'].')<br />';?>
                                                <?php
...
<?php
		...
		$mail->isHTML(true);
		$mail->Subject = "Redeem History Notification On Fixcomart";
