<?php
	...
	$mail->addAddress($emailmember, "Approval Member Notification On Fixcomart"); 
                ...
                <table cellpadding="0" cellspacing="0" border="0" id="grey-wrap" width="650">
                    ...
                    <tr>
                        ...
                        <td style="padding:25px; padding-top:5px;">
							 ...
							 <h1 style="color:#1694B9;"><?php echo'Approval Member Notification On Fixcomart';?></h1>
							 ...
							 <table cellpadding="0" cellspacing="0" border="0" id="white-wrap" bgcolor="#ffffff" style="margin-bottom:10px;" width="100%">
                                ...
                                <tr>
                                    ...
                                    <td style="padding:2px;">
                                        ...
                                        <p>
                                        	 Selamat status member corporate anda sudah active, Silahkan login sebagai corporate member.
                                        </p>
...
<?php
		...
		$mail->isHTML(true);
		$mail->Subject = "Approval Member Notification On Fixcomart";
