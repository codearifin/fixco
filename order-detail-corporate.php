	...
	<div class="container">
    	<div class="row">
            ...
            <div class="template-wrap">
                ...
                <a href="<?php echo $GLOBALS['SITE_URL'];?>order-history-corporate" class="f-1200-14px">&laquo; Kembali ke History Pembelian</a><br><br>
                	...
                	<tbody>
                            ...
                            <?php else:?>
                                ...
                                <?php if($row['deposit_amount']>0):?>
                                    ...
                                    <tr>
                                        <td><strong style="letter-spacing:0.04em; color:#ffa827;">Bayar Deposit</strong></td>
                                        <td style="text-align:right;"><strong style="font-size:1.3em; color:#ffa827;">- Rp. <?php echo number_format($row['deposit_amount']);?></strong></td>
                                    </tr>
                                    
                                    <tr>
                                        <td><strong style="letter-spacing:0.04em;">Sisa Pembayaran</strong></td>
                                        <td style="text-align:right;"><strong class="f-red" style="font-size:1.3em;">Rp. <?php echo number_format($totalamount-$row['deposit_amount']);?></strong></td>
                                    </tr>	
