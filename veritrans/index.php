...
// Set our server key
Veritrans_Config::$serverKey = 'VT-server-WteolAkiunql4-dUaXlNld2w';
...
if($Handlingfee>0):
	//Ongkos Kirim
	$ongkirnohand = $ongkirno+1;
	$itemHandlingFee = array(
		'id' => $ongkirnohand,
		'price' => $Handlingfee,
		'quantity' => 1,
		'name' => "Handling Fee"
	);
	$items_detailsListOdr = array_push($items_details, $itemHandlingFee);
endif;
