<?php include("header.php"); 
	...
	$idmember = $ros['idmember_list']; $iduser = $ros['id']; $status_user = $ros['status'];
	
	//filter ordder
	if(isset($_SESSION['sort_filtertahuncorp'])): $sort_filtertahun = $_SESSION['sort_filtertahuncorp']; else: $sort_filtertahun = ""; endif;	
?>
</head>
    	...
    	<div class="row">
            ...
            <div class="template-wrap">
                ...
                <div class="table-sort">
                    ...
                    <div class="input-wrap">
						...
						?>        
                         ...
                         <input type="hidden" name="name_sort" class="name_sortuid" value="sort_filtertahuncorp" /> 
                        </div><!-- .select-style -->
                    </div><!-- .input-wrap -->
                </div><!-- .table-sort -->
                <div class="order-table">
                    ...
                    <div class="ot-body">
						<?php getorderlistcop($idmember,$sort_filtertahun,$iduser,$status_user);?>
                    </div><!-- .ot-body -->
                </div><!-- .order-table -->
            </div><!-- .template-wrap -->
        </div><!-- .row -->
