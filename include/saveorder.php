...
if(isset($_POST['submit'])){
		...
		if($TokenIdform==1):
				...
				elseif($typeidbanktrf=='Kredivo'):
					$idbanktrf = 0;	
					$payment_metod = 'Kredivo';	
					$kodeuniklorder = 0;

				elseif($typeidbanktrf=='COD'):
					$idbanktrf = 0;	
					$payment_metod = 'COD';	
					$kodeuniklorder = 0;
					
				elseif($typeidbanktrf == "BNI eCollection"):	
					$idbanktrf = 0;	
					$payment_metod = 'BNI eCollection';	
					$kodeuniklorder = 0;	
				...
				$odrListitem['bca_tokenId'] = '';
				$odrListitem['kode_trxno_klikpay1'] = '';
				$odrListitem['kode_trxno_klikpay2'] = '';
				$odrListitem['kode_unik'] = $kodeuniklorder;
				$odrListitem['konfirmasi_bayar_byadmin'] = 0;
				$odrListitem['tanggal_konfirmasi'] = '';
				$odrListitem['konfirmasi_kirim_byadmin'] = 0;
				$odrListitem['tanggal_konfirmasi_kirim'] = '';
				$odrListitem['signature_bca'] = '';
			   ...
			   if($typeidbanktrf=='Veritrans'):	
				...
				elseif($typeidbanktrf=='Kredivo'):
					$_SESSION['tokenorderidmember'] = $tokenpaymntid;
			   		echo'<script language="JavaScript">window.location="'.$SITE_URL.'pay-kredivo";</script>';
					// echo'<script language="JavaScript">window.location="'.$SITE_URL.'kredivo-step2/'.$tokenpaymntid.'";</script>';
			   
			   elseif($typeidbanktrf=='BCA KlikPay'):
			   		echo'<script language="JavaScript">window.location="'.$SITE_URL.'bca-klikpay-step2/'.$tokenpaymntid.'";</script>';
				
			   elseif($typeidbanktrf == "BNI eCollection"):
			   		echo'<script language="JavaScript">window.location="'.$SITE_URL.'bni-ecollection-step2/'.$tokenpaymntid.'";</script>';	
