<?php 
	...
	$mail->addAddress($email, $registeremail_textcorporate); 

	$mail->addBCC($emailconfig, $registeremail_textcorporate); 
                ...
                <table cellpadding="0" cellspacing="0" border="0" id="grey-wrap" style="margin-bottom:10px; background-repeat:repeat-x;" width="600">
                    ...
                    <tr>
                        ...
                        <td style="padding:20px 25px 25px 25px;">
							 ...
							 <h1 style="color:#1694B9;"><?php echo $registeremail_textcorporate;?></h1>
							 ...
							 <table cellpadding="0" cellspacing="0" border="0" id="white-wrap" bgcolor="#ffffff" style="margin-bottom:10px;" width="100%">
                                ...
                                <tr>
                                    ...
                                    <td style="padding:20px;">   
                                           ...
                                           <p>Contact Person	: <?php echo $name;?> <?php echo $lastname;?></p>
...
<?php
		...
		$mail->Subject = $registeremail_textcorporate;
