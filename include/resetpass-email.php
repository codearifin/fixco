<?php 
	...
	$mail->addAddress($email, $resetpassid_text); 
    ...
    <table cellpadding="0" cellspacing="0" border="0" width="100%">
    	...
    	<tr>
        	...
        	<td style="padding:10px;">
                ...
                <table cellpadding="0" cellspacing="0" border="0" id="grey-wrap" style="margin-bottom:10px; background-repeat:repeat-x;" width="700">

                    <tr>

                        <td style="padding:20px 25px 25px 25px;">

							 <h1 style="color:#1694B9;">Reset Password Notification</h1>
							 ...
							 <table cellpadding="0" cellspacing="0" border="0" id="white-wrap" bgcolor="#ffffff" style="margin-bottom:10px;" width="100%">
                                ...
                                <tr>
                                    ...
                                    <td style="padding:15px; font-size:15px;">   
                                        ...
                                        <p>We have successfully reset your password. 

                                           <br />Please find your new login details below:</p>

                                        <p> Email 			: <strong style="font-size:14px;"><?php echo $email;?></strong></p>

                                        <p> New Password 	: <strong style="font-size:14px;"><?php echo $newpass;?></strong></p>                                

																				<p> Now you can <a href="<?php echo $GLOBALS['WEBSITE_NAME'];?>" title="" target="_blank">login</a> using new password.</p>
